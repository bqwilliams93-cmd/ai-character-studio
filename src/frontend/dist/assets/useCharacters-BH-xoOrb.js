...
const Trait = Text;
const PersonalityType$1 = Variant({
  "analytical": Null,
  "creative": Null,
  "introverted": Null,
  "mysterious": Null,
...
const CreateCharacterRequest = Record({
  "traits": Vec(Trait),
  "name": Text,
  "personalityType": PersonalityType$1,
  "personalityDescription": Text,
  "avatarStyle": AvatarStyle$1,
  "backgroundSnippet": Text
});
const CharacterId = Nat;
...
const CharacterFilter = Record({
  "trait": Opt(Trait),
  "personalityType": Opt(PersonalityType$1),
  "searchQuery": Opt(Text)
});
Service({
  "createCharacter": Func([CreateCharacterRequest], [Character], []),
  "getCharacter": Func([CharacterId], [Opt(Character)], ["query"]),
  "listCharacters": Func(
    [CharacterFilter],
    [Vec(Character)],
    ["query"]
  ),
  "listPersonalityTypes": Func([], [Vec(PersonalityType$1)], ["query"]),
  "listTraits": Func([], [Vec(Trait)], ["query"])
});
const idlFactory = ({ IDL: IDL2 }) => {
  const Trait2 = IDL2.Text;
  const PersonalityType2 = IDL2.Variant({
    "analytical": IDL2.Null,
    "creative": IDL2.Null,
    "introverted": IDL2.Null,
    "mysterious": IDL2.Null,
    "playful": IDL2.Null,
    "adventurous": IDL2.Null,
    "extroverted": IDL2.Null,
    "empathetic": IDL2.Null
  });
  const AvatarStyle2 = IDL2.Variant({
    "illustrated": IDL2.Null,
    "anime": IDL2.Null,
    "realistic": IDL2.Null,
    "pixelArt": IDL2.Null,
    "watercolor": IDL2.Null
  });
  const CreateCharacterRequest2 = IDL2.Record({
    "traits": IDL2.Vec(Trait2),
    "name": IDL2.Text,
    "personalityType": PersonalityType2,
    "personalityDescription": IDL2.Text,
    "avatarStyle": AvatarStyle2,
    "backgroundSnippet": IDL2.Text
  });
  const CharacterId2 = IDL2.Nat;
  const Character2 = IDL2.Record({
    "id": CharacterId2,
    "traits": IDL2.Vec(Trait2),
    "name": IDL2.Text,
    "createdAt": IDL2.Int,
    "isPreseeded": IDL2.Bool,
    "personalityType": PersonalityType2,
    "personalityDescription": IDL2.Text,
    "avatarStyle": AvatarStyle2,
    "backgroundSnippet": IDL2.Text
  });
  const CharacterFilter2 = IDL2.Record({
    "trait": IDL2.Opt(Trait2),
    "personalityType": IDL2.Opt(PersonalityType2),
    "searchQuery": IDL2.Opt(IDL2.Text)
  });
  return IDL2.Service({
    "createCharacter": IDL2.Func([CreateCharacterRequest2], [Character2], []),
    "getCharacter": IDL2.Func([CharacterId2], [IDL2.Opt(Character2)], ["query"]),
    "listCharacters": IDL2.Func(
      [CharacterFilter2],
      [IDL2.Vec(Character2)],
      ["query"]
    ),
    "listPersonalityTypes": IDL2.Func(
      [],
      [IDL2.Vec(PersonalityType2)],
      ["query"]
    ),
    "listTraits": IDL2.Func([], [IDL2.Vec(Trait2)], ["query"])
  });
};
...
var AvatarStyle = /* @__PURE__ */ ((AvatarStyle2) => {
  AvatarStyle2["illustrated"] = "illustrated";
  AvatarStyle2["anime"] = "anime";
  AvatarStyle2["realistic"] = "realistic";
  AvatarStyle2["pixelArt"] = "pixelArt";
  AvatarStyle2["watercolor"] = "watercolor";
  return AvatarStyle2;
})(AvatarStyle || {});
var PersonalityType = /* @__PURE__ */ ((PersonalityType2) => {
  PersonalityType2["analytical"] = "analytical";
  PersonalityType2["creative"] = "creative";
  PersonalityType2["introverted"] = "introverted";
  PersonalityType2["mysterious"] = "mysterious";
  PersonalityType2["playful"] = "playful";
  PersonalityType2["adventurous"] = "adventurous";
  PersonalityType2["extroverted"] = "extroverted";
  PersonalityType2["empathetic"] = "empathetic";
...
function from_candid_AvatarStyle_n11(_uploadFile, _downloadFile, value) {
  return from_candid_variant_n12(_uploadFile, _downloadFile, value);
}
function from_candid_Character_n7(_uploadFile, _downloadFile, value) {
  return from_candid_record_n8(_uploadFile, _downloadFile, value);
}
function from_candid_PersonalityType_n9(_uploadFile, _downloadFile, value) {
...
function from_candid_variant_n10(_uploadFile, _downloadFile, value) {
  return "analytical" in value ? "analytical" : "creative" in value ? "creative" : "introverted" in value ? "introverted" : "mysterious" in value ? "mysterious" : "playful" in value ? "playful" : "adventurous" in value ? "adventurous" : "extroverted" in value ? "extroverted" : "empathetic" in value ? "empathetic" : value;
}
function from_candid_variant_n12(_uploadFile, _downloadFile, value) {
  return "illustrated" in value ? "illustrated" : "anime" in value ? "anime" : "realistic" in value ? "realistic" : "pixelArt" in value ? "pixelArt" : "watercolor" in value ? "watercolor" : value;
}
...
function to_candid_AvatarStyle_n5(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n6(_uploadFile, _downloadFile, value);
}
function to_candid_CharacterFilter_n14(_uploadFile, _downloadFile, value) {
  return to_candid_record_n15(_uploadFile, _downloadFile, value);
}
function to_candid_CreateCharacterRequest_n1(_uploadFile, _downloadFile, value) {
  return to_candid_record_n2(_uploadFile, _downloadFile, value);
}
function to_candid_PersonalityType_n3(_uploadFile, _downloadFile, value) {
...
function AvatarDisplay({
  ...
  const gradient = AVATAR_GRADIENTS[avatarStyle] ?? "from-muted to-muted-foreground/20";
  const initials = name.split(/\s+/).slice(0, 2).map((w) => {
    var _a2;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: initials || AVATAR_PATTERNS[avatarStyle] || "?"
    }
  );
}
...
function useCharacters(filter2 = {}) {
  const { actor, isFetching } = useActor(createActor);
  return useQuery({
    queryKey: ["characters", filter2],
    queryFn: async () => {
      if (!actor) return [];
      return actor.listCharacters(filter2);
    },
    enabled: !!actor && !isFetching,
    staleTime: 3e4
  });
}
function useCharacter(id2) {
  const { actor, isFetching } = useActor(createActor);
  return useQuery({
    queryKey: ["character", id2 == null ? void 0 : id2.toString()],
    queryFn: async () => {
      if (!actor || id2 === null) return null;
      return actor.getCharacter(id2);
    },
...
export {
  ...
  PERSONALITY_EMOJIS as P,
  Slot as S,
  useTraits as a,
  PERSONALITY_LABELS as b,
  useCharacter as c,
  AVATAR_STYLE_COLORS as d,
  AVATAR_STYLE_LABELS as e,
  cva as f,
  createSlot as g,
  useCreateCharacter as h,
  AvatarStyle as i,
  PersonalityType as j,
  AVATAR_STYLE_BG as k,
  isHTMLElement as l,
  motion as m,
  useConstant as n,
  PresenceContext as o,
  usePresence as p,
